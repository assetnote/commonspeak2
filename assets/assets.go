...
// sources:
// sql/github/nodejs-routes.sql
// sql/github/rails-routes.sql
// sql/github/tomcat-routes.sql
...
var _sqlGithubNodejsRoutesSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")

func sqlGithubNodejsRoutesSqlBytes() ([]byte, error) {
	return bindataRead(
		_sqlGithubNodejsRoutesSql,
		"sql/github/nodejs-routes.sql",
	)
}

func sqlGithubNodejsRoutesSql() (*asset, error) {
	bytes, err := sqlGithubNodejsRoutesSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "sql/github/nodejs-routes.sql", size: 0, mode: os.FileMode(420), modTime: time.Unix(1534039257, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _sqlGithubRailsRoutesSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")

func sqlGithubRailsRoutesSqlBytes() ([]byte, error) {
	return bindataRead(
		_sqlGithubRailsRoutesSql,
		"sql/github/rails-routes.sql",
	)
}

func sqlGithubRailsRoutesSql() (*asset, error) {
	bytes, err := sqlGithubRailsRoutesSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "sql/github/rails-routes.sql", size: 0, mode: os.FileMode(420), modTime: time.Unix(1534039227, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _sqlGithubTomcatRoutesSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")

func sqlGithubTomcatRoutesSqlBytes() ([]byte, error) {
	return bindataRead(
		_sqlGithubTomcatRoutesSql,
		"sql/github/tomcat-routes.sql",
	)
}

func sqlGithubTomcatRoutesSql() (*asset, error) {
	bytes, err := sqlGithubTomcatRoutesSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "sql/github/tomcat-routes.sql", size: 0, mode: os.FileMode(420), modTime: time.Unix(1534039265, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	"sql/github/nodejs-routes.sql": sqlGithubNodejsRoutesSql,
	"sql/github/rails-routes.sql": sqlGithubRailsRoutesSql,
	"sql/github/tomcat-routes.sql": sqlGithubTomcatRoutesSql,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"sql": &bintree{nil, map[string]*bintree{
		"github": &bintree{nil, map[string]*bintree{
			"nodejs-routes.sql": &bintree{sqlGithubNodejsRoutesSql, map[string]*bintree{}},
			"rails-routes.sql": &bintree{sqlGithubRailsRoutesSql, map[string]*bintree{}},
			"tomcat-routes.sql": &bintree{sqlGithubTomcatRoutesSql, map[string]*bintree{}},
